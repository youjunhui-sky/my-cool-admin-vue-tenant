					...
					<div class="tables-row">
						...
						<div class="table-group">
							<div class="table-with-button">
								...
								<div class="operation-buttons-table1">
									<el-button
										type="primary"
										size="small"
										@click="onMoveUpResult"
										:disabled="!hasSelectedResultRow"
										>上移</el-button
									>
									<el-button
										type="primary"
										size="small"
										@click="onMoveDownResult"
										:disabled="!hasSelectedResultRow"
										>下移</el-button
									>
		...
		.lower-content {
			...
			.tables-row {
				...
				.table-group {
					...
					display: flex;
					flex-direction: column;
					flex: 0 0 calc(40% - 5px); // 各占2/5减去间距
					max-width: calc(40% - 5px);
					min-height: 0;
					gap: 10px;

					// 第二个表格组（tableData2）增加高度
					&:nth-child(2) {
						.table-with-button {
							min-height: 200px;
						}
