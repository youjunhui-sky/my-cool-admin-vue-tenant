...
function refresh() {
	const ages = ['age1', 'age2', 'age3', 'age4', 'age5', 'age6', 'age7', 'age8', 'age9'];
	...
	chartOption.xAxis.data = props.ageData.map(e => e.component);

	chartOption.series = ages.map(weightKey => ({
		name: map.get(weightKey),
		type: 'line',
		stack: '',
		data: props.ageData.map(item => Number(item[weightKey]))
	})) as ChartSeriesItem[];
}
